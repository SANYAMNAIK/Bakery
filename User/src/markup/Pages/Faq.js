										...
										<div className="row">
											<div className="col-lg-12">
												<div className="section-head text-left">
													...
													<p>Curious about our delectable offerings or services? Ask away! We're here to answer all your questions and make your bakery experience truly satisfying.</p>
												</div>
											</div>
										</div>
										<div className="row">
...
function ParaBlog(){
	return(
		<>
			<p> We offer a wide range of freshly baked goods, including cakes, pastries, cookies, cupcakes, and artisan bread.</p>
			<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
		</>
	)
}
