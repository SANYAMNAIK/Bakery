...
function Settings() {
    ...
    const url = "http://localhost:5000/api/admin/renderer";
    const url1 = "http://localhost:5000/api/admin/profile/dp-change";
    const url2 = "http://localhost:5000/api/admin/profile/data-change";
    const url3 = "http://localhost:5000/api/admin/profile/social-change";
    const url4 = "http://localhost:5000/api/admin/profile/pass-reset";
