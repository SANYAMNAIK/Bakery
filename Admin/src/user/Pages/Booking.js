							...
							<div className="col-xl-6 col-lg-6 m-b30">
								<div className="appointment-form">
									<div className="section-head m-b30">
										...
										<p>Choose the perfect date and time for your delightful treats at our online bakery shop. Personalize your order by selecting from our convenient scheduling options, ensuring a seamless and sweet experience.</p>
									</div>
									...
									<form method="post" className="dzForm" action="script/contact.php">
										...
										<div className="row sp15">
											...
											<div className="col-md-12">
											<Link to={'/shop-sidebar'}><button name="submit" type="submit" value="Submit" className="btn btnhover">CONTACT US</button></Link>
											</div>
										</div>
									</form>
								</div>
