					...
					<Carousel.Item>
						<div className="slide" style={{ backgroundImage: "url("+ slider1 +")"}} >
							...
							<div className="content">
								...
								<h4 className="sub-title">The Best Cakes In Valsad</h4>
								<Link to={"/our-menu-2"} className="btn btnhover">Trending</Link>
					...
					<Carousel.Item>
						<div className="slide" style={{ backgroundImage: "url("+ slider2 +")"}} >
							...
							<div className="content">
								...
								<h4 className="sub-title">The Best Bakery In Valsad</h4>
								<Link to={"/our-menu-2"} className="btn btnhover">Trending</Link>
